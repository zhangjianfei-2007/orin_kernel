...
char spi_frame_TX[BYTE_LEN] = {0X56,0X30,0x00,0x00,0x00,0x00,0x00,0x00,0x08,0x09};
...
int main(int argc, char *argv[])
{
	...
	//while(1)
	{
		...
		if((0x56 == rx[0])&&(0x30 == rx[1]))
		{
			printf("------------\n");
			printf("Change the date :2023.%02x.%02x \nMCU HW VersionDATA:%02x \nMCU SW VersionDATA:%02x \n",rx[4],rx[5],rx[2],rx[3]);
			printf("------------\n");
		}
						//printf("XXX\n ");
		usleep(50000);
