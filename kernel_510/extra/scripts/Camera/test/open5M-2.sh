...
v4l2src device=/dev/video$2 ! 'video/x-raw, width=(int)2880, height=(int)1860, format=(string)YUY2, framerate=(fraction)30/1' ! nvvidconv ! 'video/x-raw(memory:NVMM), width=(int)1440, height=(int)930, format=(string)NV12' ! nv3dsink -ev
