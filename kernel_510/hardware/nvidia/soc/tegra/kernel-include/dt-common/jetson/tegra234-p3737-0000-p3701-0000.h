...
//#define SPI1_SLAVE_DRIVER
#define SPI1_SLAVE_HANDLER

/* HY017C MAX9296A des board(J1) <--> P3737-A04 carrier board(J509)
 * CAM0_RST_L: PIN 95 of J1 <--> L5 (UART4_TX) ph3
 * CAM1_RST_L: PIN 93 of J1 <--> L49 (UART4_CTS) ph6
 * CAM2_RST_L: PIN 90 of J1 <--> F10 (SPI5_SCK) pac0
 * CAM3_RST_L: PIN 92 of J1 <--> F9 (SPI5_MISO) pac1
 * DC 12V <--> pull down pa1
 * */
#define CAM0_RST_L	TEGRA234_MAIN_GPIO(H, 3)
#define CAM1_RST_L	TEGRA234_MAIN_GPIO(H, 6)
#define CAM2_RST_L	TEGRA234_MAIN_GPIO(AC, 0)
#define CAM3_RST_L	TEGRA234_MAIN_GPIO(AC, 1)
