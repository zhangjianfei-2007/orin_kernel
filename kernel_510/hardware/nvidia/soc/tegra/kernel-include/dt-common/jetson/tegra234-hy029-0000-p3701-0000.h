...
/*
 * Definitions for HYXZ hy029 board.
 */
...
#define SPI2_SLAVE_DRIVER
//#define SPI2_SLAVE_HANDLER

#define SPI1_SPIDEV
//#define SPI1_MCU_DEBUG

//only for orin-1: G4 F5 F6 E10
#define CAM0_RST_L	TEGRA234_MAIN_GPIO(H, 7)
#define CAM1_RST_L	TEGRA234_MAIN_GPIO(I, 0)
#define CAM2_RST_L	TEGRA234_MAIN_GPIO(I, 1)
#define CAM3_RST_L	TEGRA234_MAIN_GPIO(AC, 7)

#define EQOS_RGMII_MV88E6352
#define XFI_AQR113C
